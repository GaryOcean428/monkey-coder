...
# Add package to path
core_path = Path(__file__).parent.parent / "packages" / "core"
sys.path.insert(0, str(core_path))
try:
    from monkey_coder.compliance import ModelManifestValidator  # type: ignore[import-not-found]
except Exception as e:
    raise SystemExit(f"Failed to import compliance module from {core_path}: {e}")
