...
async def test_code_generation(provider: str, model: str, task: str) -> Dict[str, Any]:
    """Test code generation with a specific provider and model."""
...
async def main():
    ...
    test_cases = [
        ("openai", "gpt-4-turbo"),  # Using available model
        ("anthropic", "claude-3-5-sonnet-20241022"),  # Latest Claude
        ("google", "gemini-1.5-pro"),  # Available Gemini model
    ...
    for provider, model in test_cases:
        ...
        result = await test_code_generation(provider, model, task)
        ...
        if result["success"]:
            ...
            if "result" in response_data:
                ...
                if "mock" in code_str.lower() or "generated by" in code_str.lower():
                    print(f"⚠️  WARNING: Response appears to be MOCK data!")
                ...
                if "usage" in response_data:
                    ...
                    if usage and usage.get("total_tokens", 0) == 0:
                        print(f"⚠️  WARNING: Token count is 0 - likely MOCK response!")
                    elif usage:
