...
- `claude-opus-4-6` - Most capable and intelligent model
- `claude-sonnet-4-5` - High-performance with exceptional reasoning
- `claude-opus-4-5` - Previous generation flagship
- `claude-haiku-4-5` - Intelligence at blazing speeds
...
**Grok Models:**
- `grok-4` - xAI's most advanced reasoning model
