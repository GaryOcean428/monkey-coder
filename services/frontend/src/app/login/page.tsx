        ...
        <div className="mx-auto w-full max-w-sm">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              {/* TODO: Wire to NextAuth signIn('google') once providers implemented */}
              <Button variant="outline" disabled title="Google OAuth coming soon">
              ...
              {/* TODO: Wire to NextAuth signIn('github') once providers implemented */}
              <Button variant="outline" disabled title="GitHub OAuth coming soon">
